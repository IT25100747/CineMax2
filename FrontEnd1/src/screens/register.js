// // // filepath: src/screens/register.js
...
// //           <button type="submit" class="w-full bg-red-600 hover:bg-red-500 text-white py-3 rounded-xl font-semibold transition-colors">
// //             Create Account
// //           </button>
// //         </form>
...
// //     // Hide error and redirect to login (simulated registration)
